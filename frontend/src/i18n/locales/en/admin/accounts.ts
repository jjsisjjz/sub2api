export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc: 'Account-scoped identity policy for OpenAI OAuth. Single-session random is the default: all four dimensions use separate stable account domains. Choose multi-session concurrency when running simultaneous windows or sharing an account; installation/session stay stable while thread/window are isolated per client session. Only explicit off preserves raw client identifiers.',
        codexFingerprintOff: 'Off (passthrough)',
        codexFingerprintDevice: 'Device only',
        codexFingerprintSession: 'Device + Session',
        codexFingerprintFull: 'Full convergence',
        codexFingerprintRandom: 'Independent random (single session)',
        codexFingerprintRandomMulti: 'Independent random (multi-session concurrency)',
