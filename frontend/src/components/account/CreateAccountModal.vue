...
const buildOpenAIExtra = (base?: Record<string, unknown>): Record<string, unknown> | undefined => {
  ...
  if (openAIResponsesWeeklyOverdraftEnabled.value) {
    extra.openai_responses_weekly_overdraft_enabled = true
  } else {
    delete extra.openai_responses_weekly_overdraft_enabled
  }
  ...
  // Persist the selected policy explicitly; random is the default and off is
  // the only passthrough mode.
